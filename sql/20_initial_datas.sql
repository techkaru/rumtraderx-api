...
INSERT INTO product (id, is_active, category, sku, name, slug, description, made_from, distillation_type, aging_climate, aging_type, batch, abv, size, bottled_year, year, age, total_bottles, created_date, main_picture, is_single_cask, cask_number, is_bio, is_parcellaire, is_approved, is_discontinued, updated_date, production_method_detail_id, brand_id, distillery_id, bottler_id, canne_type_id, region, production_method, country) VALUES
    (1, true, 'Old rum', null, 'Bielle 2016', 'bielle-2016', 'Brut de Fût de 7ans 2016', 'Molasse', 'distillation_type', 'tropical', 'aging_type', 1, 54.6, 70, 2009, 2016, 7, 5000, '2023-11-09', 'http://test', false, null, false, false, true, false, '2023-11-09', 1, 1, 1, 1, 1, 'Marie-Galante', 'Column Still', 'gp');